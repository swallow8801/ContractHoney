...
const FAQ = () => {
  ...
  const faqItems = [
    ...
    },
    {
      ...
      answer:
        '계약서의 길이와 복잡성에 따라 다르지만, 대부분의 경우 분석 결과는 30-50분 소요됩니다.',
    },
    {
      question: '위법 조항과 독소 조항의 차이가 무엇인가요?',
      answer:
        '위법 조항 : 법률을 위반한 조항을 의미합니다. \n독소 조항 : 계약자에게 불리한 영햐을 미치는 조항을 의미합니다.',
    },
    {
      question: '업로드된 계약서는 안전하게 보호되나요?',
      answer:
        '네, 모든 파일은 업로드 후 암호화되며, 고객의 개인정보와 계약서 내용은 철저히 보호됩니다.',
    },
  ];
