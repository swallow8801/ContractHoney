...
import { SwiperStyled, Group, ContentTxt, ContentImg, ContentSubtitle, SwiperContainer } from "./Swiper.styled"
  ...
  return (
    <SwiperContainer>
      ...
      >
        <SwiperSlide>
          <Group>
            <ContentImg src="/images/위법조항.png" alt="위법조항과 독소조항" />
            <ContentTxt>위법조항</ContentTxt>
            <ContentSubtitle>
              위법조항은 법률에 명백하게 위배된 조항을 말해요
            </ContentSubtitle>
            <ContentImg src="/images/독소조항.png" alt="위법조항과 독소조항" />
            <ContentTxt>독소조항</ContentTxt>
            <ContentSubtitle>
              독소조항은 해석에 따라 불리하게 작용할 수 있는 조항을 말해요.
            </ContentSubtitle>
          </Group>
        </SwiperSlide>
        <SwiperSlide>
